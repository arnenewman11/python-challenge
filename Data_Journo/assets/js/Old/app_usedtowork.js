...
var currentyAxisLabel = "diabetes";

// Call findMinAndMax() with 'hair_length' as default
findMinAndMax(currentxAxisLabel,currentyAxislabel);
  ...
  chart.selectAll("circle")
    ...
    .enter().append("circle")
      ...
      .attr("cy", function(data, index) {
        return yLinearScale(data.diabetes);
      })
      .attr("r", "15")
      .attr("fill", "red")
...
// Append x-axis labels
  chart.append("text")
    ...
    .attr("class", "axisText")
    .text("% of Population with Diabetes");
  });
}